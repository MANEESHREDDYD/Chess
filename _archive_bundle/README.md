...
- Stockfish in a Web Worker, fixed depth 10, CDN fallback if local file missing
...
This project: **AGPL-3.0**. See `LICENSE` (you must fetch the full canonical text before public release — see comments at the top of that file).
