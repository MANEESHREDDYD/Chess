...
export const BATTLEFIELD_ASSETS: BattlefieldAsset[] = [
  ...
  { name: 'production GLB model slot contract', kind: 'piece', source: 'procedural', license: 'project (AGPL-3.0-or-later, generated in code)', aiGenerated: false, notes: 'strict file contract in public/assets/3d/kurukshetra-production-v1/README.md; actual GLBs must be approved/licensed before use' },
