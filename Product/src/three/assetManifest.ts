...
export const BATTLEFIELD_ASSETS: BattlefieldAsset[] = [
  ...
  { name: 'war banners and battle-line soldiers', kind: 'prop', source: 'procedural', license: 'project (AGPL-3.0-or-later, generated in code)', aiGenerated: false, notes: 'disabled from the live close-review scene until upgraded from prototype geometry' },
